        ...
        <form id="registro" class="registro" action="../index.html" method="POST">
            <div id="datos-usuario" class="registro caja clearfix">
                ...
                <div class="campo">
                    ...
                    <input type="text" id="email" name="email" placeholder="tu_correo@elect.com">
                </div>

                <div id="error"> </div>
                
            </div><!-- Cierre Datos Usuario -->

            <div id="paquetes" class="paquetes">
                <h3>Elige el número de voletos</h3>
                ...
                <ul class="lista-precios clearfix">
                    <li>
                        <div class="tabla-precio">
                            ...
                            <div class="orden">
                                <label for="pase_dia">Número de voletos:</label>
                    ...
                    <li>
                        <div class="tabla-precio">
                            ...
                            <div class="orden">
                                <label for="pase_completo">Número de voletos:</label>
                    ...
                    <li>
                        <div class="tabla-precio">
                            ...
                            <div class="orden">
                                <label for="pase_dosdias">Número de voletos:</label>
                                <input type="number" min="0" id="pase_dosdias" size="3" placeholder="0">
                            </div>
                        </div>
                    </li><!-- Item 3 -->
                </ul><!-- Cierre Lista de Precios -->
            ...
            <div id="resumen" class="resumen clearfix">
                ...
                <div class="caja clearfix">
                    <div class="extras">
                        ...
                        <div class="orden">
                            <label for="etiquetas">Paquete de 10 Etiquetas $2 <small>(HTML5, CSS3, JavaScript, React, Node JS, GitHub, GitLab, Angular, Vue JS, Php)</small></label>
                        ...
                        <div class="orden">
                            ...
                            <select id="regalo" required>
                                ...
                                <option value="LIB">Libreta</option>
                            </select>
                        </div><!-- Orden 3 -->
                    ...
                    <div class="total">
                        ...
                        <input id="btn_registro" type="submit" class="boton" value="Pagar">
                    </div><!-- Cierre Total -->

                </div><!-- Contenedor Caja -->
            </div><!-- Cierre Resumen -->

        </form><!-- Cierre Formmularios -->
    </section>
